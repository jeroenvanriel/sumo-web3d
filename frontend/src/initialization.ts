  ...
  try {
    const {dom, ...resources} = await promiseObject({
      ...
      arrows: promiseObject({
        left: loadOBJFile('/models/arrows/LeftArrow.obj'),
        right: loadOBJFile('/models/arrows/RightArrow.obj'),
        uturn: loadOBJFile('/models/arrows/UTurnArrow.obj'),
        straight: loadOBJFile('/models/arrows/StraightArrow.obj'),
      }),
      dom: domPromise,
